...
func (a *NoopAuth) RequirePermission(userID string, permission string) error { return ErrCommonUnavailable }
...
// Set 写入缓存值
func (c *NoopCache) Set(key string, value interface{}, ttlSeconds int) error { return ErrCommonUnavailable }
...
func (i *NoopIdempotency) CheckAndSet(key string, ttlSeconds int) (bool, error) { return false, ErrCommonUnavailable }

// NoopLock 默认的空实现
type NoopLock struct{}

// Acquire 获取锁
func (l *NoopLock) Acquire(key string, ttlSeconds int) (bool, error) { return false, ErrCommonUnavailable }
...
// Subscribe 订阅事件
func (b *NoopEventBus) Subscribe(topic string, handler func(interface{})) error { return ErrCommonUnavailable }